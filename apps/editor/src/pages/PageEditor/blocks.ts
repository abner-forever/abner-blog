...
export const blocks: BlockProperties[] = [
  // ==================== 内容组件 ====================
  {
    id: "heading",
    label: "标题",
    content: '<h1 style="margin:10px 0;">标题文本</h1>',
    category: { id: "content", label: "内容组件", open: true },
  },
  {
    id: "text",
    label: "文本",
    content: '<p style="margin:10px 0;">段落文本内容</p>',
    category: "内容组件",
  },
  {
    id: "image",
    label: "图片",
    content:
      '<img src="https://placehold.co/600x400" alt="图片描述" loading="lazy" style="max-width:100%;height:auto;display:block;" />',
    category: "内容组件",
  },
  {
    id: "button",
    label: "按钮",
    content:
      '<a href="#" style="display:inline-flex;align-items:center;gap:6px;padding:10px 24px;background:#1890ff;color:#fff;border-radius:4px;text-decoration:none;font-size:14px;cursor:pointer;"><span>●</span><span>按钮</span></a>',
    category: "内容组件",
  },
  {
    id: "divider",
  ...
  },
  {
    ...
    content:
      '<div style="padding:56.25% 0 0 0;position:relative;border-radius:8px;overflow:hidden;background:#000;"><iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;" allowfullscreen loading="lazy" title="视频播放器"></iframe></div>',
    category: "内容组件",
  },
  {
    id: "video-bilibili",
    ...
    content:
      '<div style="padding:56.25% 0 0 0;position:relative;border-radius:8px;overflow:hidden;background:#000;"><iframe src="//player.bilibili.com/player.html?bvid=BV1GJ411x7cQ&page=1" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;" allowfullscreen loading="lazy" title="B站视频"></iframe></div>',
    category: "内容组件",
  },
  {
    id: "video-tencent",
    ...
    content:
      '<div style="padding:56.25% 0 0 0;position:relative;border-radius:8px;overflow:hidden;background:#000;"><iframe src="https://v.qq.com/txp/iframe/player.html?vid=xxxxx" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;" allowfullscreen loading="lazy" title="腾讯视频"></iframe></div>',
    category: "内容组件",
  },
  {
    id: "card",
    ...
    content:
      '<div style="border:1px solid #e8e8e8;border-radius:8px;overflow:hidden;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.06);"><img src="https://placehold.co/400x200" alt="卡片图片" style="width:100%;display:block;"/><div style="padding:16px;"><h3 style="margin:0 0 8px;font-size:18px;">卡片标题</h3><p style="margin:0;color:#666;line-height:1.6;">卡片描述内容</p></div></div>',
    category: "内容组件",
  },
  {
    id: "accordion",
    ...
    content:
      '<div style="border:1px solid #e8e8e8;border-radius:6px;overflow:hidden;"><details style="border-bottom:1px solid #e8e8e8;"><summary style="padding:12px 16px;cursor:pointer;background:#fafafa;font-weight:500;list-style:none;">标题一</summary><div style="padding:12px 16px;background:#fff;">内容一</div></details><details><summary style="padding:12px 16px;cursor:pointer;background:#fafafa;font-weight:500;list-style:none;">标题二</summary><div style="padding:12px 16px;background:#fff;">内容二</div></details></div>',
    category: "内容组件",
  },
  {
    id: "tabs",
  ...
  },
  {
    ...
    content:
      '<div style="width:100%;height:300px;border-radius:8px;overflow:hidden;"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3059.5!2d116.4!3d39.9!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMznCsDU0JzI0LjAiTiAxMTbCsDI0JzAwLjAiRQ!5e0!3m2!1szh-CN!2scn!4v1" style="width:100%;height:100%;border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>',
    category: "内容组件",
  },
  ...
  },
  {
    ...
    label: "行",
    content:
      '<div style="display:flex;flex-wrap:wrap;min-height:40px;"></div>',
    category: "布局组件",
  },
  {
    id: "column",
    label: "列",
    content:
      '<div style="flex:1;min-width:200px;padding:10px;min-height:40px;border:1px dashed #d9d9d9;"></div>',
    category: "布局组件",
  },
  {
    id: "section",
    label: "区块",
    content:
      '<section style="padding:40px 20px;min-height:100px;"></section>',
    category: "布局组件",
  },
  ...
  // ==================== 表单组件 ====================
  {
    ...
    content:
      '<form data-page-form="true" style="padding:24px;border:2px dashed #1890ff;border-radius:8px;background:#fafafa;"><div style="margin-bottom:16px;font-size:14px;color:#888;">📋 将表单字段拖入此区域</div><div style="display:flex;flex-direction:column;gap:12px;"><button type="submit" style="align-self:flex-start;padding:10px 24px;background:#1890ff;color:#fff;border:none;border-radius:4px;cursor:pointer;font-size:14px;">提交</button></div></form>',
  ...
  },
  {
    ...
    content:
      '<div class="form-field" style="margin-bottom:4px;"><label style="display:block;margin-bottom:4px;font-size:14px;font-weight:500;color:#333;">姓名</label><input type="text" name="name" placeholder="请输入" style="width:100%;padding:8px 12px;border:1px solid #d9d9d9;border-radius:4px;font-size:14px;box-sizing:border-box;"/></div>',
    category: "表单组件",
  },
  {
    id: "form-textarea",
  ...
  },
  {
    ...
    content:
      '<div class="form-field" style="margin-bottom:4px;"><label style="display:flex;align-items:center;gap:8px;font-size:14px;cursor:pointer;"><input type="checkbox" name="agree" value="1" style="width:16px;height:16px;cursor:pointer;"/> 同意条款</label></div>',
    category: "表单组件",
  },
  {
    id: "form-submit",
    ...
    content:
      '<button type="submit" style="padding:10px 32px;background:#1890ff;color:#fff;border:none;border-radius:4px;cursor:pointer;font-size:14px;font-weight:500;">提交</button>',
    category: "表单组件",
  },
  ...
  // ==================== 导航组件 ====================
  {
    ...
    content:
      '<nav style="position:sticky;top:0;background:#fff;padding:12px 24px;z-index:100;border-bottom:1px solid #e8e8e8;display:flex;gap:24px;flex-wrap:wrap;"><a href="#section1" style="color:#333;text-decoration:none;font-size:14px;padding:4px 0;border-bottom:2px solid transparent;transition:border-color 0.2s;">区块一</a><a href="#section2" style="color:#666;text-decoration:none;font-size:14px;padding:4px 0;">区块二</a><a href="#section3" style="color:#666;text-decoration:none;font-size:14px;padding:4px 0;">区块三</a></nav>',
  ...
  },
  {
    ...
    content:
      '<a href="#section" style="color:#333;text-decoration:none;font-size:14px;padding:4px 0;display:inline-block;">锚点链接</a>',
    category: "导航组件",
  },
  ...
  // ==================== 动态数据 ====================
  {
    ...
    content:
      '<div data-datalist style="padding:20px;border:1px dashed #1890ff;border-radius:8px;background:#f0f9ff;"><div style="font-size:14px;color:#1890ff;margin-bottom:12px;font-weight:500;">📊 数据列表</div><div style="display:flex;flex-direction:column;gap:8px;"><div style="padding:12px;background:#fff;border-radius:6px;border:1px solid #e8e8e8;"><div style="font-weight:500;">标题</div><div style="font-size:13px;color:#666;margin-top:4px;">描述文本</div></div><div style="padding:12px;background:#fff;border-radius:6px;border:1px solid #e8e8e8;"><div style="font-weight:500;">标题</div><div style="font-size:13px;color:#666;margin-top:4px;">描述文本</div></div><div style="padding:12px;background:#fff;border-radius:6px;border:1px solid #e8e8e8;"><div style="font-weight:500;">标题</div><div style="font-size:13px;color:#666;margin-top:4px;">描述文本</div></div></div><div style="margin-top:12px;font-size:12px;color:#aaa;text-align:center;">此组件可作为数据展示模板</div></div>',
  ...
  },
  {
    ...
    content:
      '<div style="display:inline-flex;align-items:center;gap:6px;padding:4px 12px;border-radius:20px;font-size:14px;"><span>关注者</span><span style="background:#1890ff;color:#fff;border-radius:10px;padding:2px 8px;font-size:12px;font-weight:500;">1,234</span></div>',
    category: "动态数据",
  },
  ...
  // ==================== 高级 ====================
  {
    id: "html-embed",
    label: "自定义 HTML",
    content: '<div data-gjs-type="html-embed"></div>',
