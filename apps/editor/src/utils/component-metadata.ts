...
export const REGION_DEFINITIONS = [
  {
    ...
    recommendedComponents: ['nav-menu', 'nav-link', 'container', 'image'],
  },
  {
    regionType: 'hero',
    name: '主视觉',
    description: '页面首屏大图/Banner 区域，吸引用户注意力的核心区域',
    recommendedComponents: ['container', 'text', 'button', 'image'],
  },
  {
    regionType: 'features',
    name: '特性展示',
