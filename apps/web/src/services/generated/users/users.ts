 ...
 * @summary 获取用户简历
 */
export const usersControllerGetResume = (id: string, signal?: AbortSignal) => {
...
export const getUsersControllerGetResumeQueryKey = (id: string) => {
  return [`/api/users/${id}/resume`] as const;
};

export const getUsersControllerGetResumeQueryOptions = <
  TData = Awaited<ReturnType<typeof usersControllerGetResume>>,
  TError = unknown,
>(
  id: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getUsersControllerGetResumeQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof usersControllerGetResume>>
  > = ({ signal }) => usersControllerGetResume(id, signal);
...
export type UsersControllerGetResumeQueryResult = NonNullable<
  Awaited<ReturnType<typeof usersControllerGetResume>>
>;
export type UsersControllerGetResumeQueryError = unknown;

export function useUsersControllerGetResume<
  TData = Awaited<ReturnType<typeof usersControllerGetResume>>,
  TError = unknown,
>(
  id: string,
...
export const getUsersControllerUpdateResumeMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UsersControllerUpdateResumeMutationResult = NonNullable<
  Awaited<ReturnType<typeof usersControllerUpdateResume>>
>;
 ...
 * @summary 更新当前用户简历
 */
export const useUsersControllerUpdateResume = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getUsersControllerUpdateResumeMutationOptions(options),
    queryClient,
  );
};
