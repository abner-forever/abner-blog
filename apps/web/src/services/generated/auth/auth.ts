 ...
 */
export const authControllerCaptchaConfig = (signal?: AbortSignal) => {
...
export const getAuthControllerCaptchaConfigQueryKey = () => {
  return [`/api/auth/captcha-config`] as const;
};

export const getAuthControllerCaptchaConfigQueryOptions = <
  TData = Awaited<ReturnType<typeof authControllerCaptchaConfig>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getAuthControllerCaptchaConfigQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof authControllerCaptchaConfig>>
  > = ({ signal }) => authControllerCaptchaConfig(signal);
...
export type AuthControllerCaptchaConfigQueryResult = NonNullable<
  Awaited<ReturnType<typeof authControllerCaptchaConfig>>
>;
export type AuthControllerCaptchaConfigQueryError = unknown;

export function useAuthControllerCaptchaConfig<
  TData = Awaited<ReturnType<typeof authControllerCaptchaConfig>>,
  TError = unknown,
>(
  options: {
...
export const getAuthControllerSendCodeMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerSendCodeMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerSendCode>>
>;
 ...
 * @summary 发送邮箱验证码
 */
export const useAuthControllerSendCode = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof authControllerSendCode>>,
      TError,
...
> => {
  return useMutation(
    getAuthControllerSendCodeMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getAuthControllerLoginByCodeMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerLoginByCodeMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerLoginByCode>>
>;
 ...
 * @summary 邮箱验证码登录
 */
export const useAuthControllerLoginByCode = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getAuthControllerLoginByCodeMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getAuthControllerRequestResetMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerRequestResetMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerRequestReset>>
>;
...
> => {
  return useMutation(
    getAuthControllerRequestResetMutationOptions(options),
    queryClient,
  );
};
/**
 ...
 */
export const authControllerLoginLegacy = (signal?: AbortSignal) => {
  return httpMutator<void>({
    url: `/api/auth/login-legacy`,
    method: 'POST',
    signal,
  });
};

export const getAuthControllerLoginLegacyMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerLoginLegacyMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerLoginLegacy>>
>;
 ...
 * @summary 传统本地策略登录（已废弃）
 */
export const useAuthControllerLoginLegacy = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getAuthControllerLoginLegacyMutationOptions(options),
    queryClient,
  );
};
/**
